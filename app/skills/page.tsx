      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            A comprehensive overview of my technical expertise and core competencies, built through
        ...
        <ScrollReveal>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
            <motion.div whileHover={{ scale: 1.05 }} className="glass p-6 rounded-xl text-center">
        ...
        <ScrollReveal>
          <div className="glass p-12 rounded-2xl text-center">
            ...
            <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
              ...
              frameworks, and methodologies to stay at the cutting edge of development.
            </p>

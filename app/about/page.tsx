...
const IconGithub = () => (
  ...
  >
    ...
    <path
      d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10s-4.477 10-10 10zM12 2c-1.846 0-3.543.518-5 1.38c-.01.01-.02-.02-.03-.03C4.52 4.2 2 7.31 2 12c0 4.523 4.477 10 10 10s10-4.477 10-10c0-4.69-2.52-7.8-5-8.62c-.01-.01-.02-.02-.03-.03C15.543 2.518 13.846 2 12 2z"
      clipRule="evenodd"
    ></path>
    ...
    <div className="mt-16">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        {interests.map((interest, index) => (
          <div
            key={index}
            className="text-center p-6 glass rounded-xl hover:glow-hover transition-all duration-300"
          >
    ...
    <div className="mt-16">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {values.map((value, index) => (
          <div
            key={index}
            className="p-6 glass rounded-xl border-l-4 border-indigo-500 hover:border-purple-500 transition-all duration-300"
          >
          ...
          <div className="md:col-span-1">
            <div className="glass rounded-2xl p-8 text-center sticky top-24">
              ...
              <div className="flex justify-center space-x-4">
                <a
                  href="https://github.com/sys-thai69"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3 glass rounded-lg text-gray-400 hover:text-indigo-400 hover:glow transition-all transform hover:scale-110"
                  aria-label="GitHub"
                >
                  <IconGithub />
                </a>
                <a
                  href="https://www.linkedin.com/in/chhengthai-pheav-39a683255/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-3 glass rounded-lg text-gray-400 hover:text-indigo-400 hover:glow transition-all transform hover:scale-110"
                  aria-label="LinkedIn"
              ...
              <div className="mt-6 space-y-2">
                <a
                  href="/contact"
                  className="block w-full px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-lg font-semibold hover:shadow-lg hover:shadow-indigo-500/50 transition-all"
                >
                  Hire Me
                </a>
                <a
                  href="/Pheav_Chhengthai_CV.pdf"
                  download="Pheav_Chhengthai_CV.pdf"
                  className="block w-full px-4 py-2 border border-gray-700 rounded-lg font-semibold hover:border-indigo-500 hover:bg-indigo-500/10 transition-all"
                >
                  Download CV
                </a>
              </div>
          ...
          <div className="md:col-span-2 space-y-8">
            <div className="glass p-8 rounded-2xl">
              ...
              <div className="space-y-4 text-lg text-gray-300 leading-relaxed">
                <p>
                  Hello! I&apos;m Pheav Chhengthia, a passionate student studying at{" "}
                  <strong className="text-white">Paragon International University (PIU)</strong> and
                  the <strong className="text-white">Institute of Foreign Language (IFL)</strong>. I
                  am an easy-going person driven by a{" "}
                  <span className="text-indigo-400 font-semibold">growth mindset</span> and have a
                ...
                <p>
                  My journey in technology and the industrial started with my small curiosity of how
                  things work and inspire by how advance technology is made, which evolved into a
                  passion for building solutions that make a real difference. I love to embrace
                  challenging environments that require complex problem-solving and continuous
                  learning.
                </p>
                <p>
                  My strengths include{" "}
                  <strong className="text-indigo-400">analytical problem-solving</strong>, team
                  collaboration, and adapting quickly to new technologies. When I&apos;m not coding,
                  I enjoy playing chess, exploring new tech trends, and contributing to open-source
                  projects.
                </p>
                <p>
                  I am actively seeking opportunities to apply my technical skills in real-world
                  ...
                  <span className="text-pink-400">scalable web solutions</span>.
                </p>
              </div>
            </div>
